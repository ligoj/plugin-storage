...
export default defineConfig({
  ...
  build: {
    ...
    outDir: resolve(import.meta.dirname, '../src/main/resources/META-INF/resources/webjars/storage/vue'),
    emptyOutDir: true,
    rollupOptions: {
  ...
  server: { port: 5310, proxy: { '/rest': { target: 'http://localhost:8080', changeOrigin: true }, '/webjars': { target: 'http://localhost:8080', changeOrigin: true } } },
